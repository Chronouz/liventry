    ...
    <div x-data="{ showSidebar: false, showCalendar: false }" class="flex min-h-screen">
        ...
        <div class="fixed top-0 left-0 w-full bg-diaroBlue text-white p-4 z-50 h-16 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <!-- Ikon Liventry -->
                <img src="https://storage.googleapis.com/a1aa/image/sKdLhKCvQiyzi6yTZqr_JXCci2n6kEaWoKpiTuU9o_8.jpg" class="w-10 h-10" alt="Logo">
                <!-- Teks Liventry -->
                <span class="text-2xl font-extrabold text-yellow-400 tracking-wide shadow-lg animate-pulse hover:scale-110 transform transition-transform duration-300 ease-in-out font-cursive">
                    Liventry
                </span>
            </div>
